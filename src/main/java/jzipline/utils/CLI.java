...
//    public static CallbackManager maybeShowProgress( Iterable<?> it, boolean showProgress, String[] args ) {
        ...
        */
//        if( showProgress )
//            return /*click.*/progressbar( it, args )
    
//        # context manager that just return `it` when we enter it
//        return CallbackManager.forArgs( it );
//    }
}
